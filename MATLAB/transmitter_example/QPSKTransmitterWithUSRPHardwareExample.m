...
%
% <matlab:openExample('usrpradio/QPSKTransmitterWithUSRPHardwareExample')
% QPSKTransmitterWithUSRPHardwareExample.m>
%
% Simulink implementation using blocks: <matlab:openExample('usrpradio/QPSKTransmitterWithUSRPHardwareInSimulinkExample','supportingFile','sdruqpsktx.slx')
% sdruqpsktx.slx>.
%
...
%% Initialization
% <matlab:openExample('usrpradio/QPSKTransmitterWithUSRPHardwareExample','supportingFile','sdruqpsktransmitter_init.m')
...
% initialization file, namely
% <matlab:openExample('usrpradio/QPSKTransmitterWithUSRPHardwareExample','supportingFile','sdruqpsktransmitter_init.m')
% transmitter initialization file>. Please make corresponding changes in
% the receiver initialization file,
% <matlab:openExample('usrpradio/QPSKReceiverWithUSRPHardwareExample','supportingFile','sdruqpskreceiver_init.m')
% receiver initialization file>. The payload is then scrambled to guarantee
% a balanced distribution of zeros and ones for the timing recovery
% operation in the receiver object. The scrambled bits are modulated by the
% *QPSK Modulator* (with Gray mapping). The *Raised Cosine Transmit Filter*
% upsamples the modulated symbols by two, and has roll-off factor of 0.5.
% The output rate of the *Raised Cosine Filter* is set to be 400k samples
% per second with a symbol rate of 200k symbols per second. If MATLAB
% Coder(TM) is enabled, the output symbol rate is 500k symbols per second.
...
%% Execution
% Before running the script, first turn on the USRP radio and connect it to
% the computer. As already mentioned, you can check the correct data
% transmission by running the
% <matlab:openExample('usrpradio/QPSKReceiverWithUSRPHardwareExample') QPSK
% Receiver with USRP Hardware> example while running the transmitter
% script.
...
% <matlab:openExample('usrpradio/QPSKTransmitterWithUSRPHardwareExample','supportingFile','sdruqpsktransmitter_init.m')
% transmitter initialization file> and in the
% <matlab:openExample('usrpradio/QPSKReceiverWithUSRPHardwareExample','supportingFile','sdruqpskreceiver_init.m')
...
%
% * <matlab:openExample('usrpradio/QPSKTransmitterWithUSRPHardwareExample','supportingFile','runSDRuQPSKTransmitter.m') runSDRuQPSKTransmitter.m>
% * <matlab:openExample('usrpradio/QPSKTransmitterWithUSRPHardwareExample','supportingFile','sdruqpsktransmitter_init.m') sdruqpsktransmitter_init.m>
